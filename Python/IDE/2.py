...
imagepath = os.path.join(scriptdir, "logo.png")
...
o = os.path.join(scriptdir, "open.png")
s = os.path.join(scriptdir, "save.png")
r = os.path.join(scriptdir, "run.png")

Open=PhotoImage(file=o)
Save=PhotoImage(file=s)
Run=PhotoImage(file=r)
